                ...
                <div class="sb2-13">
                    <ul class="collapsible" data-collapsible="accordion">
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-braille" aria-hidden="true"></i> Ui-Kits</a>
                            ...
                            <li><a href="javascript:void(0)" class="collapsible-header active"><i class="fa fa-rss" aria-hidden="true"></i> Blog & Articals</a>
                                <div class="collapsible-body left-sub-menu">
                                    <ul>
                                        <li><a href="blog-all.php" class="menu-active">All Blogs</a>
                                        </li>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Directory</td>
                                <td>24 may, 2017</td>
                                <td><a href="blog-edit.php" class="sb2-2-1-edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                </td>
