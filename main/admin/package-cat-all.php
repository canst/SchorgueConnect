                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header active"><i class="fa fa-umbrella" aria-hidden="true"></i> Tour Packages</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    ...
                                    <li><a href="package-cat-all.php" class="menu-active">All Package Categories</a>
                                    </li>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>24 may, 2017</td>
                                    <td><a href="package-cat-edit.php" class="sb2-2-1-edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                    </td>
