            ...
            <div class="sb2-1">
                ...
                <div class="sb2-13">
                    <ul class="collapsible" data-collapsible="accordion">
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header active"><i class="fa fa-picture-o" aria-hidden="true"></i> Sight Seeings</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    <li><a href="sight-see-all.php" class="menu-active">All Sight Seeings</a>
                                    </li>
            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#"> Edit Sight Seeing</a>
                        </li>
                            ...
                            <form>
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input id="list-title" type="text" value="Sight Seeing Name" class="validate">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input id="Sight-Seeing-auth" type="text" value="David Villiam" class="validate">
                                        <label for="Sight-Seeing-auth">Author Name</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field col s12">
