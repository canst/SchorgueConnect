                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header active"><i class="fa fa-h-square" aria-hidden="true"></i> Hotels</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    ...
                                    <li><a href="hotel-room-type-all.php" class="menu-active">Room Type</a>
                                    </li>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>24 may, 2017</td>
                                <td><a href="hotel-room-type-edit.php" class="sb2-2-1-edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                </td>
